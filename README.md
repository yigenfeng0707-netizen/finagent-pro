...
**核心差异化**：FinAgent Pro 是唯一实现多Agent DAG并行协作+决策可解释+学术级风险量化+全栈开源的智能投顾系统。
...
│   │   └── esg_analyst.py       # ESG分析师 (Phase 2骨架)
...
| POST | `/api/esg/analyze` | ESG分析（Phase 2骨架） |
...
- **ESG投资方向**：系统架构已预留ESG评级数据接口（Phase 2规划），可引导资金流向可持续发展领域
