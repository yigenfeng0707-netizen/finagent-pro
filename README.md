...
- `stress_test` — 2008金融危机/2015股灾/2020疫情/温和回调4种压力情景
- `markowitz_optimize` — 1000次随机采样生成有效前沿，输出最大夏普比率和最小波动率组合
...
- **ESG投资方向**：系统架构支持ESG评级数据集成，可引导资金流向可持续发展领域
- **低碳运营**：DAG并行执行减少40%计算时间，降低LLM Token消耗和碳排放
