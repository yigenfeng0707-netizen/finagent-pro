...
async def test_market_analyst_analyze(mock_llm):
    ...
    with patch.object(analyst, 'call_tool', new_callable=AsyncMock, return_value={
        "current_price": 350.0, "change_pct": 1.5, "volume": 1000000,
        "ma5": 348.0, "ma20": 345.0, "ma60": 340.0,
        "macd_dif": 2.5, "rsi": 55.0, "volatility": 1.2,
        "bb_upper": 360.0, "bb_lower": 330.0,
        "high_52w": 400.0, "low_52w": 280.0
    }):
...
async def test_risk_manager_analyze(mock_llm):
    ...
    with patch.object(manager, 'call_tool', new_callable=AsyncMock, return_value={
        "portfolio_volatility": 18.5, "portfolio_var_95": -2.3,
        "risk_level": "中风险", "risk_level_num": 55,
        "stock_risks": [{"symbol": "00700", "weight": 1.0, "volatility": 18.5, "var_95": -2.3, "max_drawdown": -15.0}]
    }):
